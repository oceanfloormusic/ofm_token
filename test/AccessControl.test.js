...
// Role ROLE_ROLE_MANAGER allows modifying operator roles and global features
...
contract('Access Control', (accounts) => {
	...
	it("updating features: add, remove, require feature manager", async() => {
        ...
        // await expectRevert(ac.updateFeatures(SOME_PERM, {from: operator}), "insufficient privileges (ROLE_ACCESS_MANAGER required)");
